...
Monster templates are stored as JSON files in `data/monsters/`. They define the base attributes, combat stats, and behavior for creatures that can appear in scenarios.
