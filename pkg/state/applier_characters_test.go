...
func (m *mockMonsterStorage) GetMonster(_ context.Context, templateID string) (*character.Monster, error) {
...
func TestApplier_MonsterSpawn(t *testing.T) {
	gs := &GameState{
		WorldLocations: map[string]scenario.Location{
			"cellar": {Name: "Dark Cellar", Monsters: map[string]*character.Monster{}},
		},
	}
