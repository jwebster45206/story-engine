...
const strictRefereeExamples = `Example:	{"allowed":true,"reasoning":"The PC can move to the drawbridge.","reaction":null,"scope":"movement","focus":{"npcs":[],"locations":["drawbridge"]}}
Example:	{"allowed":false,"reasoning":"The PC cannot move to the banquet hall because it is blocked.","reaction":"The PC would be stopped by the guard.","scope":"movement","focus":{"npcs":[],"locations":["banquet hall"]}}

Example:	{"allowed":true,"reasoning":"The PC attacks the giant rat.","reaction":null,"scope":"combat","focus":{"npcs":[],"locations":[]}}
Example:	{"allowed":false,"reasoning":"There is no giant rat to attack.","reaction":null,"scope":"combat","focus":{"npcs":[],"locations":[]}}
Example:	{"allowed":false,"reasoning":"The PC cannot dictate that the guard is defeated in the attack. The PC's attack occurs, but outcome is decided by the narrator.","reaction":null,"scope":"combat","focus":{"npcs":["guard"],"locations":[]}}`
