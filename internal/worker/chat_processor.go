...
// UpdateGameState updates game state after streaming is complete.
...
func (p *ChatProcessor) UpdateGameState(ctx context.Context, gs *state.GameState, userMessage, responseMessage string, isStoryEvent bool) error {
